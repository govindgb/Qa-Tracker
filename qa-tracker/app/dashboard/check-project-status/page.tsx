                    ...
                    <tr key={p._id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3 text-sm font-medium text-gray-900">{p.project_name}</div>
                        </div>
                      </td>
                          ...
                          {editingId === p._id ? (
                            <>
                              ...
                              <button
                                ...
                                className="px-3 py-1.5 bg-gray-400 text-white text-sm rounded-md hover:bg-gray-500 transition-colors"
                              >
                                Cancel
                              </button>
                            </>
